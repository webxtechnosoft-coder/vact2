...
export default function ZephyrRtosTraining() {
    return (
        <MainLayout>
            <Head title="ZephyrRtosTraining" />
            <link rel="stylesheet" href="/assets/css/zephyr-rtos-training.css" />
            
{/* BREADCRUMBS SECTION START */}
    <section class="ul-breadcrumb ul-section-spacing">
        <div class="ul-container">
            <h2 class="ul-breadcrumb-title">Zephyr RTOS Training</h2>
            <ul class="ul-breadcrumb-nav">
                <li><a href="index.html">Home</a></li>
                <li><span class="separator"><i class="flaticon-right"></i></span></li>
                <li>Zephyr RTOS Training</li>
            </ul>
        </div>
    </section>
                            ...
                            <div class="col-xl-5 col-lg-5 col-md-12">
                                <div class="product-carousel-img-container">
                                    <div class="testimonial-one__img">
                                        <img src="/assets/images/training/all.png" alt="Zephyr RTOS Architecture" style={{ "width": "100%", "borderRadius": "8px" }} />
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-12">
                                <div class="testimonial-one__single product-carousel-single">
                                    ...
                                    <h2 class="product-carousel-title">
                                        Zephyr RTOS <br /><span style={{ "color": "#008ed2" }}>IoT Architecture</span></h2>
                                    <p class="testimonial-one__text" style={{ "fontSize": "15px", "lineHeight": "1.8", "color": "#a0aec0" }}>Master Zephyr RTOS, the modern, scalable, and highly modular real-time operating system backed by the Linux Foundation. Learn how to configure projects using Kconfig and describe hardware using DeviceTree (DTS).</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12">
                                <div class="testimonial-one__single product-carousel-single">
                                    ...
                                    <p class="testimonial-one__text" style={{ "fontSize": "15px", "lineHeight": "1.8", "color": "#a0aec0" }}>Get certified in Zephyr RTOS IoT Development. Validate your skill in multi-threaded IoT programming, Zephyr device driver models, thread workqueues, and integrated BLE telemetry services.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row align-items-stretch">
                    ...
                    <div class="col-lg-7 mb-5 mb-lg-0">
                        <div class="spotlight-content-wrapper">
                            ...
                            <h3 class="product-details__title" style={{ "fontSize": "36px", "fontWeight": "800", "color": "#1e293b", "lineHeight": "1.2", "marginBottom": "15px" }}>Zephyr RTOS Training</h3>
                            <p style={{ "fontWeight": "700", "color": "var(--eduvers-base)", "fontSize": "18px", "marginBottom": "20px" }}>Build Smarter Connected Products with Zephyr RTOS</p>
                            <p class="product-details__content-text1" style={{ "background": "rgba(0, 142, 210, 0.02)", "borderLeft": "4px solid var(--eduvers-base)", "padding": "15px 20px", "borderRadius": "4px 12px 12px 4px", "fontSize": "15px", "fontWeight": "600", "color": "#475569", "lineHeight": "1.6", "marginBottom": "-20px" }}>
                                Give your engineering team the skills to build faster, safer, and smarter embedded products with our hands-on Zephyr RTOS corporate training. Zephyr is an open-source, scalable RTOS purpose-built for the connected world ? from tiny IoT sensors to full-featured industrial systems. At VAct Technologies, we bring real-world experience, field-tested hardware, and practical development workflows to your workspace ? helping teams bridge the gap between theory and product deployment.
                            </p>
                            <div class="testimonial-one__text" style={{ "fontSize": "15px", "lineHeight": "1.8", "color": "#64748b", "marginBottom": "-20px" }}>
                                <strong>Why Choose Our Zephyr RTOS Training?</strong>
                                <ul style={{ "listStyleType": "disc", "marginLeft": "20px", "marginTop": "10px", "color": "#64748b" }}>
                                    <li><strong>Real Hardware, Real Code:</strong> Your team will train on custom-built embedded boards, not just simulations. We emphasize hands-on learning to match real product use cases.</li>
                                    <li><strong>Tailored for Your Industry:</strong> Whether you?re building IoT sensors, automotive ECUs, or wearable health devices ? we customize our sessions to fit your domain and device class.</li>
                                    <li><strong>From Fundamentals to Production:</strong> Learn Zephyr?s architecture, device trees, drivers, multithreading, peripherals, power management, and connectivity protocols ? all in one course.</li>
                                </ul>
                            </div>
    ...
    <section class="course-highlights-section">
        <div class="container">
            {/* Row 1: Why Zephyr RTOS (left) + Applications & Key Features (right) */}
            <div class="row">
                {/* Left Column: Why Zephyr RTOS */}
                <div class="col-lg-6 mb-4 mb-lg-0">
                    ...
                    <div class="ch-box wow fadeInLeft" data-wow-delay="100ms">
                        <div class="ch-box-title-wrapper">
                            ...
                            <h3 class="ch-box-title">Why Zephyr RTOS?</h3>
                        </div>
                        <p class="ch-box-desc">
                            Zephyr is the fastest-growing open-source RTOS, trusted by Intel, Nordic Semiconductor, NXP,
                            and backed by the Linux Foundation. It supports 500+ boards and is built for modern
                            connected, safety-critical embedded products.
                        </p>
                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-layer-group"></i></div>
                            <div class="ch-feature-content">
                                <h5>Modular Microkernel Design</h5>
                                <p>Configure only the kernel features your application needs dramatically reducing
                                    memory footprint and attack surface.</p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-wifi"></i></div>
                            <div class="ch-feature-content">
                                <h5>Rich Connectivity Stack</h5>
                                <p>Built-in support for Bluetooth, BLE Mesh, Wi-Fi, 802.15.4, CAN, USB, and more 
                                    production-ready out of the box.</p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-lock"></i></div>
                            <div class="ch-feature-content">
                                <h5>Security &amp; Memory Protection</h5>
                                <p>Stack canaries, MPU/MMU isolation, secure boot, and TF-M integration make Zephyr
                                    ideal for security-critical IoT devices.</p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            ...
                            <div class="ch-feature-content">
                                ...
                                <p>Runs on x86, ARM Cortex-M/A/R, RISC-V, ARC, MIPS, and Xtensa  one codebase, many
                                    targets.</p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            ...
                            <div class="ch-feature-content">
                                <h5>Modern Tooling (West + CMake)</h5>
                                <p>West workspace manager, CMake build system, ninja, and VSCode integration provide a
                                    smooth professional development experience.</p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-users"></i></div>
                            <div class="ch-feature-content">
                                <h5>Thriving Open-Source Community</h5>
                                <p>Thousands of contributors and an active mailing list, Discord, and GitHub  meaning
                                    rapid bug fixes, new board support, and feature additions.</p>
                            </div>
                        </div>

                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-bolt"></i></div>
                            <div class="ch-feature-content">
                                <h5>Real-Time Performance</h5>
                                <p>Provides deterministic scheduling and low-latency interrupt handling, making it ideal for time-critical embedded and IoT applications.</p>
                            </div>
                        </div>

                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-cloud"></i></div>
                            <div class="ch-feature-content">
                                <h5>Cloud & IoT Integration</h5>
                                <p>Supports seamless connectivity with major cloud platforms and IoT services, enabling rapid development of connected devices.</p>
                            </div>
                        </div>
                        ...
                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-microchip"></i></div>
                            <div class="ch-feature-content">
                                <h5>Optimized Resource Utilization</h5>
                                <p>Designed to run efficiently on resource-constrained devices with minimal RAM and Flash requirements.</p>
                            </div>
                        </div>
                    </div>
                </div>
                {/* Right Column: Applications + Key Features */}
                <div class="col-lg-6 mb-4 mb-lg-0">
                    {/* Applications Box */}
                    <div class="ch-box wow fadeInRight" data-wow-delay="200ms">
                        <div class="ch-box-title-wrapper">
                            <div class="ch-box-icon"><i class="fas fa-laptop-code"></i></div>
                            <h3 class="ch-box-title">Applications of Zephyr RTOS Training</h3>
                        </div>
                        <p class="ch-box-desc" style={{ "marginBottom": "12px" }}>
                            This training is ideal for teams building:
                        </p>
                        <ul class="ch-simple-list">
                            <li><strong>Automotive ECUs:</strong> With ISO 26262 compliance goals and real-time
                                performance</li>
                            <li><strong>IoT Sensor Networks:</strong> Low-power mesh networks and edge gateways</li>
                            <li><strong>Medical Wearables:</strong> Secure patient monitoring and remote diagnostics</li>
                            <li><strong>Industrial Automation:</strong> Heavy-duty controllers and HMI panels</li>
                            <li><strong>Consumer Electronics:</strong> Ultra-low power smart products and wearables</li>
                        </ul>
                    </div>

                    {/* Key Features Box */}
                    <div class="ch-box wow fadeInRight" data-wow-delay="300ms" style={{ "background": "#ffffff", "borderRadius": "24px", "padding": "35px 30px", "border": "1px solid rgba(0, 142, 210, 0.07)", "boxShadow": "0 15px 35px rgba(0, 0, 0, 0.03)" }}>
                        <div class="ch-box-title-wrapper" style={{ "display": "flex", "alignItems": "center", "gap": "15px", "marginBottom": "25px" }}>
                            <div class="kf-badge-icon" style={{ "width": "48px", "height": "48px", "background": "rgba(0, 142, 210, 0.08)", "color": "#008ed2", "borderRadius": "12px", "display": "flex", "alignItems": "center", "justifyContent": "center", "fontSize": "20px", "border": "1px solid rgba(0, 142, 210, 0.12)" }}>
                                <i class="fas fa-star"></i>
                            </div>
                            <h3 class="ch-box-title" style={{ "margin": "0", "fontSize": "24px", "fontWeight": "800", "color": "#1e293b" }}>Key Features</h3>
                        </div>

                        <div class="kf-list" style={{ "display": "flex", "flexDirection": "column", "gap": "16px" }}>
                            {/* Feature 1 */}
                            <div class="kf-item" style={{ "display": "flex", "alignItems": "center", "gap": "16px", "background": "#f8fafc", "border": "1px solid #f1f5f9", "padding": "16px 20px", "borderRadius": "12px", "transition": "all 0.3s ease", "boxShadow": "0 2px 4px rgba(0,0,0,0.01)" }}>
                                <div class="kf-check-icon" style={{ "width": "28px", "height": "28px", "background": "rgba(56, 189, 248, 0.12)", "color": "#0284c7", "borderRadius": "50%", "display": "flex", "alignItems": "center", "justifyContent": "center", "fontSize": "11px", "flexShrink": "0", "border": "1.5px solid rgba(56, 189, 248, 0.25)" }}>
                                    <i class="fas fa-check"></i>
                                </div>
                                <div class="kf-text" style={{ "fontSize": "14px", "lineHeight": "1.5", "color": "#475569", "fontWeight": "500" }}>
                                    <strong style={{ "color": "#1e293b", "fontWeight": "700" }}>Customizable Curriculum</strong> <span style={{ "color": "#cbd5e1", "margin": "0 6px" }}>?</span> Aligned with your product development needs
                                </div>
                            </div>
                            ...
                            <div class="kf-item" style={{ "display": "flex", "alignItems": "center", "gap": "16px", "background": "#f8fafc", "border": "1px solid #f1f5f9", "padding": "16px 20px", "borderRadius": "12px", "transition": "all 0.3s ease", "boxShadow": "0 2px 4px rgba(0,0,0,0.01)" }}>
                                ...
                                <div class="kf-text" style={{ "fontSize": "14px", "lineHeight": "1.5", "color": "#475569", "fontWeight": "500" }}>
                                    <strong style={{ "color": "#1e293b", "fontWeight": "700" }}>Elite Training</strong> <span style={{ "color": "#cbd5e1", "margin": "0 6px" }}>?</span> Delivered by industry-certified embedded engineers
                                </div>
                            </div>
                            ...
                            <div class="kf-item" style={{ "display": "flex", "alignItems": "center", "gap": "16px", "background": "#f8fafc", "border": "1px solid #f1f5f9", "padding": "16px 20px", "borderRadius": "12px", "transition": "all 0.3s ease", "boxShadow": "0 2px 4px rgba(0,0,0,0.01)" }}>
                                ...
                                <div class="kf-text" style={{ "fontSize": "14px", "lineHeight": "1.5", "color": "#475569", "fontWeight": "500" }}>
                                    <strong style={{ "color": "#1e293b", "fontWeight": "700" }}>Hands-On Labs</strong> <span style={{ "color": "#cbd5e1", "margin": "0 6px" }}>?</span> Includes interactive practice with custom development boards
                                </div>
                            </div>
                            ...
                            <div class="kf-item" style={{ "display": "flex", "alignItems": "center", "gap": "16px", "background": "#f8fafc", "border": "1px solid #f1f5f9", "padding": "16px 20px", "borderRadius": "12px", "transition": "all 0.3s ease", "boxShadow": "0 2px 4px rgba(0,0,0,0.01)" }}>
                                ...
                                <div class="kf-text" style={{ "fontSize": "14px", "lineHeight": "1.5", "color": "#475569", "fontWeight": "500" }}>
                                    <strong style={{ "color": "#1e293b", "fontWeight": "700" }}>Post-Training Support</strong> <span style={{ "color": "#cbd5e1", "margin": "0 6px" }}>?</span> Ongoing support for implementation and debugging
                                </div>
                            </div>
                            ...
                            <div class="kf-item" style={{ "display": "flex", "alignItems": "center", "gap": "16px", "background": "#f8fafc", "border": "1px solid #f1f5f9", "padding": "16px 20px", "borderRadius": "12px", "transition": "all 0.3s ease", "boxShadow": "0 2px 4px rgba(0,0,0,0.01)" }}>
                                ...
                                <div class="kf-text" style={{ "fontSize": "14px", "lineHeight": "1.5", "color": "#475569", "fontWeight": "500" }}>
                                    <strong style={{ "color": "#1e293b", "fontWeight": "700" }}>Flexible Setup</strong> <span style={{ "color": "#cbd5e1", "margin": "0 6px" }}>?</span> Conducted on-site or remotely based on your team's locations
                                </div>
                            </div>
                            ...
                            <div class="kf-item" style={{ "display": "flex", "alignItems": "center", "gap": "16px", "background": "#f8fafc", "border": "1px solid #f1f5f9", "padding": "16px 20px", "borderRadius": "12px", "transition": "all 0.3s ease", "boxShadow": "0 2px 4px rgba(0,0,0,0.01)" }}>
                                ...
                                <div class="kf-text" style={{ "fontSize": "14px", "lineHeight": "1.5", "color": "#475569", "fontWeight": "500" }}>
                                    <strong style={{ "color": "#1e293b", "fontWeight": "700" }}>Skill Assessment</strong> <span style={{ "color": "#cbd5e1", "margin": "0 6px" }}>?</span> Includes certification and performance tracking
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            {/* Row 2: Advantages Table */}
            <div class="row" style={{ "marginTop": "24px" }}>
                {/* Advantages Table (full width) */}
                <div class="col-lg-12">
                    <div class="ch-box wow fadeInUp" data-wow-delay="100ms">
                        <div class="ch-box-title-wrapper">
                            <div class="ch-box-icon"><i class="fas fa-award"></i></div>
                            <h3 class="ch-box-title">Advantages of Zephyr RTOS</h3>
                        </div>
                        <div style={{ "overflowX": "auto" }}>
                            <table class="freertos-compare-table">
                                ...
                                <tbody>
                                    <tr>
                                        <td><strong>Modular and Scalable</strong></td>
                                        <td class="highlight-cell">Tailor the OS footprint to fit from low-power MCUs to complex SoCs</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Security-Centric</strong></td>
                                        <td class="highlight-cell">Supports memory protection, stack canaries, and secure boot</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Multi-Architecture Support</strong></td>
                                        <td class="highlight-cell">x86, ARM, ARC, RISC-V, MIPS, and more</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Fast Boot Time</strong></td>
                                        <td class="highlight-cell">Highly optimized boot sequence for instantaneous execution</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Rich Connectivity</strong></td>
                                        <td class="highlight-cell">Built-in support for Bluetooth, BLE Mesh, Ethernet, Wi-Fi, 802.15.4</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Excellent Tooling</strong></td>
                                        <td class="highlight-cell">Supports modern development stacks (VSCode, GDB, west, cmake, ninja)</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Strong Community &amp; Vendor Backing</strong></td>
                                        <td class="highlight-cell">Supported by the Linux Foundation and major chipmakers (Intel, NXP, Nordic)</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="why-choose-one__left">
                        <div class="section-title text-left sec-title-animation animation-style2">
                            ...
                            <h2 class="section-title__title title-animation">VAct Technologies
                                ...
                                <span>Zephyr RTOS Training</span>
                            </h2>
                        </div>
                        <p class="why-choose-one__text"> VAct Technologies Zephyr RTOS course provides
