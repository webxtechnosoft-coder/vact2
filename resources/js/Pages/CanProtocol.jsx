...
export default function CanProtocol() {
    return (
        <MainLayout>
            <Head title="CanProtocol" />
            
{/* BREADCRUMBS SECTION START */}
    <section class="ul-breadcrumb ul-section-spacing">
        <div class="ul-container">
            <h2 class="ul-breadcrumb-title">CAN Protocol</h2>
                            ...
                            <div class="col-xl-5 col-lg-5 col-md-12">
                                <div class="product-carousel-img-container">
                                    <div class="testimonial-one__img">
                                        <img src="/assets/images/training/can_protocol.png" alt="Master CAN Protocol" style={{ "width": "100%", "borderRadius": "8px" }} />
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-12">
                                <div class="testimonial-one__single product-carousel-single">
                                    ...
                                    <h2 class="product-carousel-title">
                                        Controller Area <br /><span style={{ "color": "#008ed2" }}>Network (CAN)</span></h2>
                                    <p class="testimonial-one__text" style={{ "fontSize": "15px", "lineHeight": "1.8", "color": "#a0aec0" }}>Master the intricacies of the CAN protocol, a critical communication standard in modern vehicles. Dive deep into frame formats, message arbitration, fault confinement, bit timing, and physical layer transceiver configurations used by automotive leaders.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12">
                                <div class="testimonial-one__single product-carousel-single">
                                    ...
                                    <p class="testimonial-one__text" style={{ "fontSize": "15px", "lineHeight": "1.8", "color": "#a0aec0" }}>Earn an industry-recognized certification upon completing the CAN Protocol course. Showcase your verified automotive simulation, CAPL scripting, and ECU diagnostics credentials to top-tier global employers.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row align-items-stretch">
                    ...
                    <div class="col-lg-7 mb-5 mb-lg-0">
                        <div class="spotlight-content-wrapper">
                            ...
                            <h3 class="product-details__title" style={{ "fontSize": "36px", "fontWeight": "800", "color": "#1e293b", "lineHeight": "1.2", "marginBottom": "15px" }}>Controller Area Network Training Course</h3>
                            <p style={{ "fontWeight": "700", "color": "var(--eduvers-base)", "fontSize": "18px", "marginBottom": "20px" }}>Delve into Controller Area Network (CAN), a communication protocol pioneered by Bosch for automotive applications.</p>
                            <p class="product-details__content-text1" style={{ "background": "rgba(0, 142, 210, 0.02)", "borderLeft": "4px solid var(--eduvers-base)", "padding": "15px 20px", "borderRadius": "4px 12px 12px 4px", "fontSize": "15px", "fontWeight": "600", "color": "#475569", "lineHeight": "1.6", "marginBottom": "-20px" }}>
                                Its versatility extends beyond automotive, finding applications in diverse industries such as industrial automation, aerospace, and medical devices. Not only does it equip you with essential knowledge, but it also serves as excellent preparation for CAN Fundamentals.
                            </p>
                            <p class="testimonial-one__text" style={{ "fontSize": "15px", "lineHeight": "1.8", "color": "#64748b", "marginBottom": "25px" }}>
                                <strong>The Objective of CAN Protocol Training:</strong><br />
                                The objective of mastering the Controller Area Network training course is to acquire comprehensive knowledge of this extensively utilized communication standard and its specific applications, particularly within the realms of embedded systems and automotive technology. Experts in CAN protocol are actively sought after by numerous sectors. Acquiring knowledge in this domain leads to employment prospects in robotics, industrial automation and automotive engineering disciplines.
                            </p>
    ...
    <section class="course-highlights-section">
        <div class="container">
            ...
            {/* Row 1: Deep-Dive (left) + 2 stacked boxes (right) */}
            <div class="row" style={{ "display": "flex", "flexWrap": "wrap", "alignItems": "flex-start" }}>

                {/* Left Column: Unlocking CAN Protocol using VAct AutoEdge Board */}
                <div class="col-lg-6 mb-4 mb-lg-0" style={{ "alignSelf": "flex-start" }}>
                    <div class="ch-box wow fadeInLeft" data-wow-delay="100ms">
                        <div class="ch-box-title-wrapper">
                            ...
                            <h3 class="ch-box-title">Unlocking CAN Protocol with VAct AutoEdge</h3>
                        </div>
                        <p class="ch-box-desc">
                            Gain hands-on expertise using the <strong>VAct AutoEdge Development Board</strong>, the only
                            embedded board in India for integrated learning of Automotive Protocols and Embedded
                            Systems. Meticulously crafted by VAct Technologies, this board features an ARM Cortex M4 as
                            its core with two dedicated CAN interfaces as a standout feature.
                        </p>

                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-plug"></i></div>
                            <div class="ch-feature-content">
                                <h5>Peripherals &amp; Dedicated CAN Channels</h5>
                                <p>Features a wide range of peripherals such as RTC, ADC, I2C, SPI, PWM, Timers, UART,
                                    and two dedicated CAN interfaces.</p>
                            </div>
                        </div>

                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-clipboard-list"></i></div>
                            <div class="ch-feature-content">
                                <h5>75+ Core Experiments</h5>
                                <p>Supports more than 75+ hands-on experiments providing a rich and diverse learning
                                    experience for automotive enthusiasts.</p>
                            </div>
                        </div>

                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-laptop-code"></i></div>
                            <div class="ch-feature-content">
                                <h5>25+ Assignments &amp; Challenges</h5>
                                <p>Includes 25+ challenging assignments and practical problems to build real-world
                        ...
                        <div class="ch-feature-item">
                            ...
                            <div class="ch-feature-content">
                                <h5>Hands-On Domain Exploration</h5>
                                <p>Facilitates practical exploration of various functionalities crucial in the
                                    automotive domain to enhance industrial skills.</p>
                            </div>
                        </div>

                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-car"></i></div>
                            <div class="ch-feature-content">
                                <h5>Automotive Protocol Learning</h5>
                                <p>Understand and implement CAN communication protocols through practical demonstrations and projects.</p>
                            </div>
                        </div>
                        ...
                        <div class="ch-feature-item">
                            ...
                            <div class="ch-feature-content">
                                <h5>Industry-Oriented Projects</h5>
                                <p>Build real-time embedded and automotive applications to gain valuable project experience.</p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-tools"></i></div>
                            <div class="ch-feature-content">
                                <h5>Hands-On Debugging Skills</h5>
                                <p>Learn effective debugging and troubleshooting techniques used in professional embedded development.</p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-graduation-cap"></i></div>
                            <div class="ch-feature-content">
                                <h5>Structured Learning Path</h5>
                                <p>Follow a step-by-step curriculum designed for beginners, students, and working professionals.</p>
                            </div>
                        </div>
                    </div>
                </div>

                {/* Right Column: QNX stacked boxes replaced with CAN Protocol content */}
                <div class="col-lg-6" style={{ "alignSelf": "flex-start" }}>

                    {/* Mastering CAN Protocol Box */}
                    <div class="ch-box wow fadeInRight" data-wow-delay="100ms" style={{ "marginBottom": "20px" }}>
                        <div class="ch-box-title-wrapper">
                            <div class="ch-box-icon"><i class="fas fa-car"></i></div>
                            <h3 class="ch-box-title">Mastering CAN with VAct Technologies</h3>
                        </div>
                        <p class="ch-box-desc" style={{ "fontSize": "14.5px", "lineHeight": "1.6", "marginBottom": "12px" }}>
                            VAct Technologies excels in delivering cutting-edge hardware and software solutions for the
                            automobile industry. We strive to innovate and develop exceptional technology applications
                            that offer unparalleled, cost-effective solutions for the ever-evolving business landscape.
                        </p>
                        <p class="ch-box-desc" style={{ "fontSize": "14.5px", "lineHeight": "1.6", "marginBottom": "0" }}>
                            At VAct Technologies, we offer online training programs for embedded systems CAN &amp; IoT.
                            Originally conceived to streamline automotive wiring with a two-wire bus, CAN has evolved
                            into a fundamental technology with widespread industrial and automotive applications
                            globally.
                        </p>
                    </div>

                    {/* Course Highlights Box */}
                    <div class="ch-box wow fadeInRight" data-wow-delay="200ms">
                        <div class="ch-box-title-wrapper">
                            <div class="ch-box-icon"><i class="fas fa-star"></i></div>
                            <h3 class="ch-box-title">Course Highlights</h3>
                        </div>
                        <ul class="ch-simple-list">
                            <li><strong>Live Project Experience</strong> Work on real-world industrial projects with
                                practical execution.</li>
                            <li><strong>Customizable Schedule</strong> Choose class timings that adapt perfectly to
                                your requirements.</li>
                            <li><strong>Personalized Coaching</strong> Undergo direct mentorship from seasoned
                                industry professionals.</li>
                            <li><strong>Virtual &amp; In-Person Sessions</strong> Attend classes online or in physical
                                training centers.</li>
                            <li><strong>Career Placement Assistance</strong> Get extensive support for securing roles
                                at top MNC companies.</li>
                            <li><strong>Industry Certification</strong> Earn a validated course certificate of
                                technical excellence.</li>
                            <li><strong>Performance Evaluations</strong> Access continuous evaluation checkpoints and
                                feedback.</li>
                        </ul>
                    </div>
            ...
            {/* Row 2: Our Core Values + Training Focus */}
            <div class="row" style={{ "marginTop": "24px", "display": "flex", "flexWrap": "wrap", "alignItems": "flex-start" }}>

                {/* Core Values Box */}
                <div class="col-lg-6 mb-4 mb-lg-0" style={{ "alignSelf": "flex-start" }}>
                    <div class="ch-box wow fadeInLeft" data-wow-delay="100ms">
                        <div class="ch-box-title-wrapper">
                            <div class="ch-box-icon"><i class="fas fa-bullseye"></i></div>
                            <h3 class="ch-box-title">Our Core Values</h3>
                        </div>
                        <ul class="ch-simple-list">
                            <li>Ensure placement support at leading multinational companies.</li>
                            <li>Enhance interview preparedness and broaden your career opportunities.</li>
                            <li>Provide hands-on training for real-world automotive-embedded job readiness.</li>
                            <li>Offer steadfast assistance for project-based learning.</li>
                            <li>Learn from accomplished, experienced instructors.</li>
                            <li>Access concise and comprehensive study materials designed for quick retention.</li>
                        </ul>
                    </div>
                </div>

                {/* Career Preparation Focus Box */}
                <div class="col-lg-6" style={{ "alignSelf": "flex-start" }}>
                    <div class="ch-box wow fadeInRight" data-wow-delay="200ms">
                        <div class="ch-box-title-wrapper">
                            <div class="ch-box-icon"><i class="fas fa-graduation-cap"></i></div>
                            <h3 class="ch-box-title">Timing &amp; Professional Growth</h3>
                        </div>
                        <p class="ch-box-desc" style={{ "fontSize": "14.5px", "lineHeight": "1.6", "marginBottom": "12px" }}>
                            The objective of mastering the CAN protocol online course is to acquire comprehensive
                            knowledge of this extensively utilized communication standard and its specific applications,
                            particularly within the realms of embedded systems and automotive technology.
                        </p>
                        <ul class="ch-simple-list">
                            <li>Delve into the theory, operation, and practical applications of the CAN protocol.</li>
                            <li>Build a solid foundation that serves as excellent preparation for CAN Fundamentals.</li>
                            <li>Elevate your skills and propel yourself toward your automotive and industrial career
                                aspirations.</li>
                        </ul>
                    </div>
                </div>
    ...
    <section>
        <div class="syllabus-wrapper">
            <h2 class="syllabus-title">Controller Area Network Training Course? Syllabus</h2>
            ...
            <div class="accordion" id="syllabusAccordion">
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <span class="ms-3">Module 1 : Controller Area Network (CAN ) & CAN Tools</span>
                    ...
                    <div id="m1" class="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                        <div class="accordion-body">
                            <ul class="syllabus-points">
                                <li><span class="dot"></span> CAN Characteristics</li>

                                <li><span class="dot"></span> CAN frame format</li>

                                <li><span class="dot"></span>Arbitration</li>

                                <li><span class="dot"></span> Applications</li>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <span class="ms-3">CAPL Programming</span>
                            <span class="plus-icon">+</span>
                        </button>
                    </h2>
                    <div id="m2" class="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                        <div class="accordion-body">
                            <ul class="syllabus-points">
                                <li><span class="dot"></span>Introduction to CAPL Programming for Simulating a CAN
                                    Network.
                                </li>

                                <li><span class="dot"></span>Signal Manipulation with CAPL.</li>

                                <li><span class="dot"></span>System and Environment Variable.</li>

                                <li><span class="dot"></span>Working with Timers.</li>

                                <li><span class="dot"></span>Creating Panel and Integrating them.</li>
                            </ul>
                ...
                <div class="accordion-item">
                    ...
                    <div id="m3" class="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                        <div class="accordion-body">
                            <ul class="syllabus-points">
                                <li><span class="dot"></span> UDS as a Transport Protocol.
                                </li>

                                <li><span class="dot"></span>Library Architecture</li>

                                <li><span class="dot"></span> Reading the Diagnostic Trouble Codes know as DTCs: Read
                                    DTC Information.</li>

                                <li><span class="dot"></span> Setting vehicle-specific configuration: Write Data by
                                    Identifier.</li>
                                <li><span class="dot"></span>Overriding IO: Input Output Control by Identifier.</li>
                                <li><span class="dot"></span>Requesting a Reset: ECU Reset.</li>
                                <li><span class="dot"></span>Fault Management using UDS Protocol.</li>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <span class="ms-3">SDLC vs STLC</span>
                            <span class="plus-icon">+</span>
                        </button>
                    </h2>
                    <div id="m4" class="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                        <div class="accordion-body">
                            <ul class="syllabus-points">
                                <li><span class="dot"></span>Waterfall Model.
                                </li>

                                <li><span class="dot"></span>Agile Model.</li>

                                <li><span class="dot"></span>Interative Model.</li>

                                <li><span class="dot"></span> V-V Model.
                                </li>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <span class="ms-3">Module 2: Working with CAN & VAct AutoEdge Development Board</span>
                            <span class="plus-icon">+</span>
                        </button>
                    </h2>
                    <div id="m5" class="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                        <div class="accordion-body">
                            <ul class="syllabus-points">
                                <li><span class="dot"></span>Introduction to CAN
                                </li>

                                <li><span class="dot"></span>Format of CAN Data Frame</li>

                                <li><span class="dot"></span>Setting up CubeIDE for STM32 </li>

                                <li><span class="dot"></span>Configure CAN Data Frame and Sending on CAN Bus
                                </li>
                                <li><span class="dot"></span>Receiving and Monitoring CAN Bu</li>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <span class="ms-3">CAN Messages</span>
                            <span class="plus-icon">+</span>
                        </button>
                    </h2>
                    <div id="m6" class="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                        <div class="accordion-body">
                            <ul class="syllabus-points">
                                <li><span class="dot"></span>Periodic & Non Periodic messages
                                </li>

                                <li><span class="dot"></span>Sending CAN Data Frames Periodically </li>

                                <li><span class="dot"></span>Sending CAN Data Frames on Event </li>

                                <li><span class="dot"></span>Simulating an ECU Network </li>
                                <li><span class="dot"></span>Monitoring Periodic messages from other node</li>
                                <li><span class="dot"></span>Event Driven message & Capture</li>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <span class="ms-3">CAN Use cases Engine ECU</span>
                            <span class="plus-icon">+</span>
                        </button>
                    </h2>
                    <div id="m7" class="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                        <div class="accordion-body">
                            <ul class="syllabus-points">
                                <li><span class="dot"></span> Engine ECU Use case definition
                                </li>

                                <li><span class="dot"></span> Engine ON/OFF CAN Message </li>

                                <li><span class="dot"></span>Read Engine ON/OFF message periodically and update</li>

                                <li><span class="dot"></span>CAN Messages to update Engine Status ( ON/OFF),
                                    Acceleration (Units),
                                    Speed ( Units) RPM ( %) </li>
                                <li><span class="dot"></span>Read Engine RPM and send as CAN Messages</li>
                                <li><span class="dot"></span>Receive Engine RPM & Speed and Display</li>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <span class="ms-3">CAN Use cases Airbag ECU</span>
                            <span class="plus-icon">+</span>
                        </button>
                    </h2>
                    <div id="m8" class="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                        <div class="accordion-body">
                            <ul class="syllabus-points">
                                <li><span class="dot"></span> Airbag ECU definition
                                </li>

                                <li><span class="dot"></span>Engine ON/OFF CAN Message
                                </li>

                                <li><span class="dot"></span> Seat Belt Message</li>

                                <li><span class="dot"></span> Engine Running Message </li>
                                <li><span class="dot"></span> Crash Detected</li>
                                <li><span class="dot"></span> Simulating airbag ECU on CAN Network</li>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <span class="ms-3">Introduction to UDS</span>
                            <span class="plus-icon">+</span>
                        </button>
                    </h2>
                    <div id="m9" class="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                        <div class="accordion-body">
                            <ul class="syllabus-points">
                                ...
                                <li><span class="dot"></span> Reading the Diagnostic Trouble Codes known as DTCs : Read DTC Information
                                </li>

                                <li><span class="dot"></span> Setting vehicle-specific configuration : Write Data by Identifier</li>

                                <li><span class="dot"></span> Overriding IO : Input Output Control by Identifier</li>
                                <li><span class="dot"></span> Requesting a Reset : ECU Reset</li>
                                <li><span class="dot"></span> Sessions and Security Control</li>
                                <li><span class="dot"></span> Fault Management using UDS Protocol</li>
                    ...
                    <div class="why-choose-one__left">
                        <div class="section-title text-left sec-title-animation animation-style2">
                            ...
                            <h2 class="section-title__title title-animation">VAct Technologies
                                ...
                                <span>Controller Area Network
                                    Training Course</span>
                            </h2>
                        </div>
                        <p class="why-choose-one__text"> VAct Technologies Controller Area Network
