...
export default function TestimonialsEdit({ testimonial }) {
            ...
            <div style={{ backgroundColor: '#fff', borderRadius: '12px', padding: '32px', border: '1px solid #e5e7eb', boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
                <form onSubmit={submit} encType="multipart/form-data">
                    ...
                    <div style={{ marginBottom: '20px' }}>
                        ...
                        <input type="text" value={data.role} onChange={(e) => setData('role', e.target.value)} style={{ width: '100%', padding: '10px 14px', border: errors.role ? '1.5px solid #dc2626' : '1px solid #d1d5db', borderRadius: '8px', fontSize: '14px', boxSizing: 'border-box' }} />
                    ...
                    <div style={{ marginBottom: '20px', display: 'flex', gap: '16px' }}>
                        ...
                        <div style={{ flex: 1 }}>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                                {testimonial.image && (
                                    <img src={testimonial.image.startsWith('http') || testimonial.image.startsWith('/') ? testimonial.image : `/storage/${testimonial.image}`} alt="Preview" style={{ width: '60px', height: '60px', borderRadius: '50%', objectFit: 'cover', border: '1px solid #e5e7eb' }} />
                                )}
