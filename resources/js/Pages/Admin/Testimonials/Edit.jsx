                        ...
                        <div style={{ flex: 1 }}>
                            ...
                            {testimonial.image && (
                                <div style={{ marginBottom: '12px' }}>
                                    <img src={testimonial.image.startsWith('http') || testimonial.image.startsWith('/') ? testimonial.image : `/storage/${testimonial.image}`} alt="Preview" style={{ width: '80px', height: '80px', borderRadius: '50%', objectFit: 'cover', border: '1px solid #e5e7eb' }} />
                                </div>
                            )}
