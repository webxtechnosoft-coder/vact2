        ...
        <AdminLayout>
            ...
            <div style={{ maxWidth: '700px', backgroundColor: '#fff', borderRadius: '12px', padding: '32px', border: '1px solid #e5e7eb', boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
                <form onSubmit={submit} encType="multipart/form-data">
                    ...
                    <div style={{ marginBottom: '20px' }}>
                        <label style={{ display: 'block', marginBottom: '6px', fontSize: '13px', fontWeight: 600, color: '#374151' }}>Associate Photo</label>
                        {placement.image && (
                            <div style={{ marginBottom: '12px' }}>
                                <img src={placement.image.startsWith('http') || placement.image.startsWith('/') ? placement.image : `/storage/${placement.image}`} alt="Preview" style={{ width: '100px', height: '100px', objectFit: 'cover', borderRadius: '50%', border: '1px solid #e5e7eb' }} />
                            </div>
                        )}
