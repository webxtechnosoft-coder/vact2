                            ...
                            {sliders.data.map((slider) => (
                                <tr key={slider.id} style={{ borderTop: '1px solid #f3f4f6' }}>
                                    ...
                                    <td style={{ padding: '14px 20px', textAlign: 'right' }}>
                                        <Link href={`/admin/sliders/${slider.id}/edit`} style={{ padding: '6px 14px', borderRadius: '6px', fontSize: '12px', fontWeight: 500, backgroundColor: '#eef9ff', color: '#008ed2', textDecoration: 'none', marginRight: '6px' }}>Edit</Link>
                                        <button onClick={() => deleteSlider(slider)} style={{ padding: '6px 14px', borderRadius: '6px', fontSize: '12px', fontWeight: 500, backgroundColor: '#fef2f2', color: '#dc2626', border: 'none', cursor: 'pointer' }}>Delete</button>
                                    </td>
                                </tr>
                            ))}
                            {sliders.data.length === 0 && (
                                <tr><td colSpan={7} style={{ padding: '40px', textAlign: 'center', color: '#9ca3af', fontSize: '13px' }}>No sliders found.</td></tr>
                            )}
                        </tbody>
                    </table>
                </div>
