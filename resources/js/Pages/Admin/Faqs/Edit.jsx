...
export default function FaqsEdit({ faq }) {
    ...
    return (
        <AdminLayout>
            ...
            <div style={{ marginBottom: '24px' }}>
                <h1 style={{ margin: 0, fontSize: '22px', fontWeight: 700, color: '#111827' }}>Edit FAQ</h1>
                <p style={{ margin: '4px 0 0', fontSize: '14px', color: '#6b7280' }}>Update FAQ question and answer details</p>
            </div>
