...
export default function RustProgrammingTraining() {
    return (
        <MainLayout>
            <Head title="RustProgrammingTraining" />
            <link rel="stylesheet" href="/assets/css/rust-programming-training.css" />
            
{/* BREADCRUMBS SECTION START */}
    <section class="ul-breadcrumb ul-section-spacing">
        <div class="ul-container">
            <h2 class="ul-breadcrumb-title">Rust Programming</h2>
                            ...
                            <div class="col-xl-5 col-lg-5 col-md-12">
                                <div class="product-carousel-img-container">
                                    <div class="testimonial-one__img">
                                        <img src="/assets/images/training/rust_programming.png" alt="Rust Memory Safety" style={{ "width": "100%", "borderRadius": "8px" }} />
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-12">
                                <div class="testimonial-one__single product-carousel-single">
                                    ...
                                    <h2 class="product-carousel-title">
                                        Rust Systems <br /><span style={{ "color": "#008ed2" }}>Programming Course</span></h2>
                                    <p class="testimonial-one__text" style={{ "fontSize": "15px", "lineHeight": "1.8", "color": "#a0aec0" }}>Master Rust, the modern systems programming language built for memory safety and high performance. Learn the ownership model, borrow checker, lifetimes, and safe concurrency patterns without a garbage collector.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12">
                                <div class="testimonial-one__single product-carousel-single">
                                    ...
                                    <p class="testimonial-one__text" style={{ "fontSize": "15px", "lineHeight": "1.8", "color": "#a0aec0" }}>Receive your professional Rust Systems Developer certificate. Highlight your experience in safe concurrency, no_std bare-metal embedded Rust, and high-performance zero-overhead driver design.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row align-items-stretch">
                    ...
                    <div class="col-lg-7 mb-5 mb-lg-0">
                        <div class="spotlight-content-wrapper">
                            ...
                            <h3 class="product-details__title" style={{ "fontSize": "36px", "fontWeight": "800", "color": "#1e293b", "lineHeight": "1.2", "marginBottom": "15px" }}>Hands-On Rust Programming</h3>
                            <p style={{ "fontWeight": "700", "color": "var(--eduvers-base)", "fontSize": "18px", "marginBottom": "20px" }}>Master modern systems development with Rust ? the language that redefines safety, speed, and control.</p>
    ...
    <section class="course-highlights-section">
        <div class="container">
            <div class="row" style={{ "display": "flex", "flexWrap": "wrap", "alignItems": "flex-start" }}>
                {/* Left Column: Key Skills You Will Learn */}
                <div class="col-lg-6 mb-4 mb-lg-0" style={{ "alignSelf": "flex-start" }}>
                    <div class="ch-box wow fadeInLeft" data-wow-delay="100ms">
                        <div class="ch-box-title-wrapper">
                            ...
                            <h3 class="ch-box-title">Key Skills You Will Learn</h3>
                        </div>
                        <p class="ch-box-desc">Develop robust, safe, and high-performance systems. Our course covers the
                            core and advanced aspects of Rust development.</p>
                        {/* Skill 1 */}
                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-key"></i></div>
                            <div class="ch-feature-content">
                                <h5>Ownership &amp; Borrowing</h5>
                                <p>Eliminate data races and null pointer bugs at compile time.</p>
                            </div>
                        </div>
                        {/* Skill 2 */}
                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-box"></i></div>
                            <div class="ch-feature-content">
                                <h5>Cargo &amp; Crates.io</h5>
                                <p>Efficient project management, package building, and dependency handling.</p>
                            </div>
                        </div>
                        {/* Skill 3 */}
                        <div class="ch-feature-item">
                            ...
                            <div class="ch-feature-content">
                                <h5>Traits &amp; Generics</h5>
                                <p>Write clean, highly reusable, and modular abstract code.</p>
                            </div>
                        </div>
                        {/* Skill 4 */}
                        <div class="ch-feature-item">
                            ...
                            <div class="ch-feature-content">
                                <h5>Pattern Matching &amp; Lifetimes</h5>
                                <p>Implement powerful control flow structures with guaranteed memory safety.</p>
                            </div>
                        </div>
                        {/* Skill 5 */}
                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-exclamation-triangle"></i></div>
                            <div class="ch-feature-content">
                                <h5>Error Handling</h5>
                                <p>Elegant, safe recovery from failures using Result and Option types.</p>
                            </div>
                        </div>
                        {/* Skill 6 */}
                        <div class="ch-feature-item">
                            ...
                            <div class="ch-feature-content">
                                <h5>Multithreading &amp; Concurrency</h5>
                                <p>Build thread-safe programs easily with Mutex, Arc, and channel-based message passing.
                                </p>
                            </div>
                        </div>
                        {/* Skill 7 */}
                        <div class="ch-feature-item">
                            ...
                            <div class="ch-feature-content">
                                ...
                                <p>Master Box, Rc, and Arc for fine-grained memory allocation and reference counting.
                                </p>
                            </div>
                        </div>
                        {/* Skill 8 */}
                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-file-alt"></i></div>
                            <div class="ch-feature-content">
                                <h5>File I/O &amp; Serde</h5>
                                <p>Build real-world CLI utilities with robust JSON/TOML data parsing and serialization.
                                </p>
                            </div>
                        </div>
                        {/* Skill 9 */}
                        <div class="ch-feature-item">
                            ...
                            <div class="ch-feature-content">
                                <h5>Embedded Rust (Optional)</h5>
                                <p>Learn no_std development and cross-compiling for bare-metal microcontrollers.</p>
                            </div>
                        </div>
                    </div>
                </div>
                {/* Right Column: Real-World Applications + Why Choose */}
                <div class="col-lg-6" style={{ "alignSelf": "flex-start" }}>
                    ...
                    <div class="ch-box wow fadeInRight" data-wow-delay="100ms" style={{ "marginBottom": "24px" }}>
                        <div class="ch-box-title-wrapper">
                            ...
                            <h3 class="ch-box-title">Real-World Applications of Rust</h3>
                        </div>
                        <ul class="ch-simple-list">
                            <li><strong>Systems Programming</strong> : Build safe OS components, compilers, and drivers.
                            </li>
                            <li><strong>Embedded Development</strong> : Target microcontrollers like Cortex-M safely and
                                efficiently.</li>
                            <li><strong>Web Backends</strong> : High-performance microservices with WebAssembly, Actix,
                                and Rocket.</li>
                            <li><strong>DevOps &amp; CLI Tools</strong> : Build ultra-fast, secure, and standalone
                                command-line applications.</li>
                            <li><strong>Security-Critical Software</strong> :Create systems that are memory-safe by
                                default.</li>
                        </ul>
                    </div>
                    {/* Why Choose Box */}
                    <div class="ch-box wow fadeInRight" data-wow-delay="200ms" style={{ "marginBottom": "0" }}>
                        <div class="ch-box-title-wrapper">
                            <div class="ch-box-icon"><i class="fas fa-check-circle"></i></div>
                            <h3 class="ch-box-title">Why Choose This Rust Program?</h3>
                        </div>
                        <ul class="ch-simple-list">
                            <li>Led by experts in Embedded &amp; Systems Development.</li>
                            <li>Focused on real-world hands-on labs and capstone projects.</li>
                            <li>Beginner-friendly, but dives deep into advanced systems concepts.</li>
                            <li>Teaches safe concurrency, memory efficiency, and modular software design.</li>
                            <li>Prepares you for deploying Rust in IoT, Web, or Embedded environments.</li>
                        </ul>
                    </div>
                </div>
            </div>
            {/* Row 2: Rust vs C/C++ Comparison Table */}
            <div class="row" style={{ "marginTop": "24px" }}>
                <div class="col-lg-12">
                    <div class="ch-box wow fadeInUp" data-wow-delay="100ms" style={{ "marginBottom": "0" }}>
                        <div class="ch-box-title-wrapper">
                            <div class="ch-box-icon"><i class="fas fa-exchange-alt"></i></div>
                            <h3 class="ch-box-title">Why Rust Over C/C++?</h3>
                        </div>
                        <p class="ch-box-desc">Compare how Rust stacks up against legacy languages for modern software
                            engineering.</p>
                            ...
                            <table class="freertos-compare-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th style={{ "width": "35%" }}>Rust</th>
                                        <th style={{ "width": "35%" }}>C/C++</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td><strong>Memory Safety</strong></td>
                                        <td class="highlight-cell">? Guaranteed (no nulls, no UBs)</td>
                                        <td>? Manual, error-prone</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Concurrency</strong></td>
                                        <td class="highlight-cell">? Data-race free by design</td>
                                        <td>? Requires extra effort</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Package Management</strong></td>
                                        <td class="highlight-cell">? Cargo</td>
                                        <td>? No native solution</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Error Handling</strong></td>
                                        <td class="highlight-cell">? Type-safe with Result, Option</td>
                                        <td>? Mostly unchecked</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Modern Syntax</strong></td>
                                        <td class="highlight-cell">? Expressive and concise</td>
                                        <td>? Verbose</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Embedded-Friendly</strong></td>
                                        <td class="highlight-cell">? no_std support, growing ecosystem</td>
                                        <td>? Mature but riskier</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
            ...
            <div class="accordion" id="syllabusAccordion">
                    ...
                    <div id="m1" class="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                        <div class="accordion-body">
                            <ul class="syllabus-points">
                                <li><span class="dot"></span> Language Fundamentals & CLI Apps (Ownership, Setup, Match,
                                    Control Flow)</li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="m2" class="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                        <div class="accordion-body">
                            <ul class="syllabus-points">
                                <li><span class="dot"></span>Ownership Model, Borrowing, Lifetimes, Collections</li>
                ...
                <div class="accordion-item">
                    ...
                    <div id="m3" class="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                        <div class="accordion-body">
                            <ul class="syllabus-points">
                                <li><span class="dot"></span> Traits, Modules, Error Handling & File Parsers</li>
                ...
                <div class="accordion-item">
                    ...
                    <div id="m4" class="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                        <div class="accordion-body">
                            <ul class="syllabus-points">
                                <li><span class="dot"></span> Concurrency, Smart Pointers, Closures, Iterators</li>
                ...
                <div class="accordion-item">
                    ...
                    <div id="m5" class="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                        <div class="accordion-body">
                            <ul class="syllabus-points">
                                <li><span class="dot"></span>File I/O, Serde, Embedded Programming, Capstone CLI Project
                                </li>
            ...
            <div class="row">
                <div class="col-xl-4">
                    <div class="why-choose-one__left">
                        ...
                        <p class="why-choose-one__text"> VAct Technologies Hands-On Rust Programming course provides
