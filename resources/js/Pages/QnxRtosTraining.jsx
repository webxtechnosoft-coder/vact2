...
export default function QnxRtosTraining() {
    return (
        <MainLayout>
            <Head title="QnxRtosTraining" />
            <link rel="stylesheet" href="/assets/css/qnx-rtos-training.css" />
            
{/* BREADCRUMBS SECTION START */}
    <section class="ul-breadcrumb ul-section-spacing">
        <div class="ul-container">
            <h2 class="ul-breadcrumb-title">QNX RTOS Training</h2>
            <ul class="ul-breadcrumb-nav">
                <li><a href="index.html">Home</a></li>
                <li><span class="separator"><i class="flaticon-right"></i></span></li>
                <li>QNX RTOS Training</li>
            </ul>
        </div>
    </section>
                            ...
                            <div class="col-xl-5 col-lg-5 col-md-12">
                                <div class="product-carousel-img-container">
                                    <div class="testimonial-one__img">
                                        <img src="/assets/images/training/qnx_rtos.png" alt="QNX RTOS Architecture" style={{ "width": "100%", "borderRadius": "8px" }} />
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-12">
                                <div class="testimonial-one__single product-carousel-single">
                                    ...
                                    <h2 class="product-carousel-title">
                                        QNX Microkernel <br /><span style={{ "color": "#008ed2" }}>RTOS Architecture</span></h2>
                                    <p class="testimonial-one__text" style={{ "fontSize": "15px", "lineHeight": "1.8", "color": "#a0aec0" }}>Master QNX RTOS - the leading microkernel operating system powering modern automotive digital cockpits and medical devices. Learn microkernel process separation, message passing, and real-time scheduling.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12">
                                <div class="testimonial-one__single product-carousel-single">
                                    ...
                                    <p class="testimonial-one__text" style={{ "fontSize": "15px", "lineHeight": "1.8", "color": "#a0aec0" }}>Earn your QNX RTOS Specialist credential. Prove your proficiency in QNX IPC primitives, pulse messages, resource managers, and QNX hardware driver architectures (Devnp, Devc) for custom hardware.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7 mb-5 mb-lg-0">
                        <div class="spotlight-content-wrapper">
                            <div class="cta-pill-tag mb-3" style={{ "background": "rgba(0, 142, 210, 0.06)", "color": "var(--eduvers-base)", "fontSize": "11px", "fontWeight": "700", "padding": "5px 12px", "borderRadius": "20px", "textTransform": "uppercase", "letterSpacing": "0.5px", "border": "1px solid rgba(0, 142, 210, 0.1)", "display": "inline-flex", "alignItems": "center", "gap": "6px", "width": "fit-content" }}>
                                <i class="fas fa-book-open"></i> Course Highlights
                            </div>
                            <h3 class="product-details__title" style={{ "fontSize": "36px", "fontWeight": "800", "color": "#1e293b", "lineHeight": "1.2", "marginBottom": "15px" }}>QNX RTOS Training</h3>
                            <p style={{ "fontWeight": "700", "color": "var(--eduvers-base)", "fontSize": "18px", "marginBottom": "20px" }}>Build Safety-Critical Systems with Precision and Performance:</p>
                            ...
                            <p class="testimonial-one__text" style={{ "fontSize": "15px", "lineHeight": "1.8", "color": "#64748b", "marginBottom": "25px" }}>
                                <strong>The Trusted RTOS for Mission-Critical Systems:</strong><br />
    ...
    <section class="course-highlights-section">
        <div class="container">
            {/* Top Section Row: Left Column (2 Cards) + Right Column (3 Cards) */}
            <div class="row">
                {/* Left Column */}
                <div class="col-lg-6 mb-4 mb-lg-0">

                    {/* Deep-Dive into QNX Capabilities */}
                    <div class="ch-box wow fadeInLeft" data-wow-delay="100ms">
                        <div class="ch-box-title-wrapper">
                            ...
                            <h3 class="ch-box-title">Deep-Dive into QNX Capabilities</h3>
                        </div>
                        <p class="ch-box-desc">
                            Our QNX RTOS Masterclass delivers specialized, hands-on modules covering the core and
                            advanced aspects of real-time embedded systems development. Designed to take you from
                            fundamentals to industry-level expertise.
                        </p>

                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-cubes"></i></div>
                            <div class="ch-feature-content">
                                <h5>Microkernel Architecture</h5>
                                <p>Learn how QNX separates core services into modular components, ensuring fault
                                    containment and system reliability.</p>
                            </div>
                        </div>
                        ...
                        <div class="ch-feature-item">
                            ...
                            <div class="ch-feature-content">
                                <h5>Multithreading &amp; Real-Time Scheduling</h5>
                                <p>Master thread priorities, scheduling policies (FIFO, Round Robin, Sporadic), and
                                    preemptive multitasking.</p>
                            </div>
                        </div>

                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-hdd"></i></div>
                            <div class="ch-feature-content">
                                <h5>Resource Managers &amp; Drivers</h5>
                                <p>Develop custom resource managers to expose hardware or services as native QNX file
                                    system objects.</p>
                            </div>
                        </div>

                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-exchange-alt"></i></div>
                            <div class="ch-feature-content">
                                <h5>Advanced IPC Mechanisms</h5>
                                <p>Implement efficient and secure communication using message passing, shared memory,
                                    pulses, and signals.</p>
                            </div>
                        </div>

                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-bug"></i></div>
                            <div class="ch-feature-content">
                                <h5>Momentics IDE &amp; Debugging Tools</h5>
                                <p>Use QNX's Momentics Tools for system profiling, tracing, memory analysis, and
                        ...
                        <div class="ch-feature-item">
                            ...
                            <div class="ch-feature-content">
                                <h5>Board Support Package (BSP) Customization</h5>
                                <p>Configure and port QNX to custom hardware platforms including ARM Cortex-A, x86, and
                                    RISC-V.</p>
                            </div>
                        </div>

                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-shield-alt"></i></div>
                            <div class="ch-feature-content">
                                <h5>Secure Boot &amp; Safety Certification</h5>
                                <p>Build systems aligned with ISO 26262, IEC 61508, and FDA medical safety standards.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="ch-box wow fadeInLeft" data-wow-delay="200ms">
                        <div class="ch-box-title-wrapper">
                            <div class="ch-box-icon"><i class="fas fa-graduation-cap"></i></div>
                            <h3 class="ch-box-title">Hands-On Learning Outcomes</h3>
                        </div>
                        <ul class="ch-simple-list">
                            <li>Design and deploy complete real-time applications on QNX</li>
                            <li>Port QNX to a new board or SoC</li>
                            <li>Interface with sensors, displays, and buses like CAN, SPI, and I2C</li>
                            <li>Debug using Momentics, GDB, and command-line tools</li>
                            <li>Optimize CPU and memory usage in constrained embedded environments</li>
                            <li>Implement fault-tolerant and watchdog-driven systems</li>
                            <li>Integrate legacy C code into QNX architecture</li>
                            <li>Configure, customize, and build QNX Board Support Packages (BSPs) from scratch</li>
                            <li>Implement multi-core symmetric multiprocessing (SMP) and thread synchronization models</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="ch-box wow fadeInRight" data-wow-delay="100ms">
                        <div class="ch-box-title-wrapper">
                            ...
                            <h3 class="ch-box-title">Key Advantages of QNX</h3>
                        </div>
                        <ul class="ch-simple-list">
                            <li><strong>Microkernel Architecture</strong> ? Ensures modularity, fault isolation, and
                                recovery without affecting the whole system.</li>
                            <li><strong>Deterministic Real-Time Performance</strong> ? Guarantees precise timing and
                                predictable task execution under heavy load.</li>
                            <li><strong>Safety-Critical Certifications</strong> ? Supports ISO 26262 (automotive), IEC
                                61508 (industrial), and FDA Class III (medical).</li>
                            <li><strong>Scalable and Secure</strong> ? Runs from low-power microcontrollers to high-end
                                automotive ECUs.</li>
                            <li><strong>POSIX-Compliant APIs</strong> ? Simplifies porting of Linux/Unix codebases with
                                real-time capabilities.</li>
                            <li><strong>Proven in Production</strong> ? Used in over 235 million vehicles, medical
                                systems, railways, and defense equipment.</li>
                        </ul>
                    </div>
                    ...
                    <div class="ch-box wow fadeInRight" data-wow-delay="200ms">
                        <div class="ch-box-title-wrapper">
                            ...
                            <h3 class="ch-box-title">Why Learn QNX?</h3>
                        </div>
                        <ul class="ch-simple-list">
                            <li>Build real-time applications with strict safety and timing requirements</li>
                            <li>Develop resource managers, drivers, and services on embedded hardware</li>
                            <li>Optimize performance using QNX Momentics Tools</li>
                            <li>Port QNX to custom hardware platforms (BSPs)</li>
                            <li>Leverage QNX for autonomous, AI-driven, and connectivity-heavy devices</li>
                        </ul>
                    </div>

                    {/* Where QNX is Used Box (Restored to Right Column to match height perfectly) */}
                    <div class="ch-box wow fadeInRight" data-wow-delay="300ms">
                        <div class="ch-box-title-wrapper">
                            <div class="ch-box-icon"><i class="fas fa-globe"></i></div>
                            <h3 class="ch-box-title">Where QNX is Used</h3>
                        </div>
                        <ul class="ch-simple-list">
                            <li><strong>Automotive:</strong> Infotainment, ADAS, digital cockpits, battery management
                                systems</li>
                            <li><strong>Medical Devices:</strong> Surgical systems, diagnostics, and patient monitors
                            </li>
                            <li><strong>Industrial:</strong> Robotics, PLCs, HMIs, and factory automation</li>
                            <li><strong>Defense &amp; Aerospace:</strong> Secure communications, UAVs, and navigation
                                systems</li>
                            <li><strong>Railway &amp; Transportation:</strong> Signaling, train control, and
            ...
            {/* Training Format Options (Placed Full-Width at the Bottom) */}
            <div class="row mt-4">
                <div class="col-lg-12">
                    <div class="ch-box wow fadeInUp" data-wow-delay="100ms" style={{ "marginBottom": "0" }}>
                        <div class="ch-box-title-wrapper" style={{ "justifyContent": "center" }}>
                            <div class="ch-box-icon"><i class="fas fa-chalkboard-teacher"></i></div>
                            <h3 class="ch-box-title">Training Format Options</h3>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <ul class="ch-simple-list" style={{ "marginTop": "0", "marginBottom": "0" }}>
                                    <li>On-Site Corporate Training</li>
                                    <li>Live Virtual Instructor-Led Sessions</li>
                                    <li>100% Hands-on training for the students</li>
                                </ul>
                            </div>
                            <div class="col-md-6">
                                <ul class="ch-simple-list" style={{ "marginTop": "0", "marginBottom": "0" }}>
                                    <li>Hybrid Training with Pre-Recorded Modules + Live Mentorship</li>
                                    <li>Post-training technical support and code reviews</li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <section>
        <div class="syllabus-wrapper">
            <h2 class="syllabus-title">QNX Neutrino RTOS Syllabus</h2>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <span class="ms-3">QNX - Process Manager and Scheduling</span>
                    ...
                    <div id="m1" class="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                        <div class="accordion-body">
                            <ul class="syllabus-points">
                                <li><span class="dot"></span> The architecture (MicroKernel)</li>

                                <li><span class="dot"></span> The Process Manager</li>

                                <li><span class="dot"></span> Basic Knowhow of Momentics IDE</li>

                                <li><span class="dot"></span> Scheduling</li>

                                <li><span class="dot"></span> Hands on creating threads and run them in FIFO vs
                                    Round-robin</li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <span class="ms-3">QNX - IPCs and Thread Synchronization</span>
                            <span class="plus-icon">+</span>
                        </button>
                    </h2>
                    <div id="m2" class="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                        <div class="accordion-body">
                            <ul class="syllabus-points">
                                <li><span class="dot"></span> IPCs provided by kernel ? Messages, Pulses and Signals
                                </li>

                                <li><span class="dot"></span>Explain each of the IPC followed by Hands on</li>

                                <li><span class="dot"></span> Thread synchronization methods ? Mutex, condvar, semaphore
                                    and join</li>

                                <li><span class="dot"></span> Discuss on each method followed by hand on.</li>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <span class="ms-3">QNX - Resource Manager and Shared Objects</span>
                            <span class="plus-icon">+</span>
                        </button>
                    </h2>
                    <div id="m3" class="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                        <div class="accordion-body">
                            <ul class="syllabus-points">
                                <li><span class="dot"></span> Understand Resource manager
                                </li>

                                <li><span class="dot"></span>Library Architecture</li>

                                <li><span class="dot"></span> System Services</li>

                                <li><span class="dot"></span> Securityl</li>
                                <li><span class="dot"></span>Networking</li>
                                <li><span class="dot"></span>Basic socket application to send/recv over UDP</li>
                                <li><span class="dot"></span>Basic client/server example over TCP</li>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <span class="ms-3">QNX Neutrino RTOS - Debugging and System Profiler</span>
                            <span class="plus-icon">+</span>
                        </button>
                    </h2>
                    <div id="m4" class="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                        <div class="accordion-body">
                            <ul class="syllabus-points">
                                <li><span class="dot"></span> Debugging using Momentics IDE
                                </li>

                                <li><span class="dot"></span>Coredump debugging remote/local</li>

                                <li><span class="dot"></span>Profiling qnx applications using Kernel Event Trace</li>

                                <li><span class="dot"></span> Hands on placing user trace and analyze the same.
                                </li>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <span class="ms-3">Design Considerations and use cases</span>
                            <span class="plus-icon">+</span>
                        </button>
                    </h2>
                    <div id="m5" class="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                        <div class="accordion-body">
                            <ul>
                            <li><span class="dot"></span> Polling vs interrrupts (example of RX pacing in network
                                driver).
                            </li>

                            <li><span class="dot"></span>Custom Memory Management (tiered pools), finding memory leaks
                            </li>

                            <li><span class="dot"></span>PTake a design problem (either from customer or from us), then
                                have attendees design a solution for the same)</li>
                    ...
                    <div class="why-choose-one__left">
                        <div class="section-title text-left sec-title-animation animation-style2">
                            ...
                            <h2 class="section-title__title title-animation">VAct Technologies
                                ...
                                <span>QNX RTOS Training</span>
                            </h2>
                        </div>
                        <p class="why-choose-one__text"> VAct Technologies QNX RTOS course provides
