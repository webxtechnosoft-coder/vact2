...
export default function EdgeaiIotDevelopment() {
    return (
        <MainLayout>
            <Head title="EdgeaiIotDevelopment" />
            <link rel="stylesheet" href="/assets/css/edgeai-iot-development-hands-on-tinyml.css" />
            
{/* BREADCRUMBS SECTION START */}
    <section class="ul-breadcrumb ul-section-spacing">
        <div class="ul-container">
            <h2 class="ul-breadcrumb-title">EdgeAI &amp; IoT / TinyML</h2>
            <ul class="ul-breadcrumb-nav">
                <li><a href="index.html">Home</a></li>
                <li><span class="separator"><i class="flaticon-right"></i></span></li>
                <li>EdgeAI &amp; IoT / TinyML</li>
            </ul>
        </div>
    </section>
                            ...
                            <div class="col-xl-5 col-lg-5 col-md-12">
                                <div class="product-carousel-img-container">
                                    <div class="testimonial-one__img">
                                        <img src="/assets/images/training/edgeai_tinyml.png" alt="Edge AI and Machine Learning" style={{ "width": "100%", "borderRadius": "8px" }} />
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-12">
                                <div class="testimonial-one__single product-carousel-single">
                                    ...
                                    <h2 class="product-carousel-title">
                                        Edge AI and <br /><span style={{ "color": "#008ed2" }}>TinyML Development</span></h2>
                                    <p class="testimonial-one__text" style={{ "fontSize": "15px", "lineHeight": "1.8", "color": "#a0aec0" }}>Deploy deep learning and machine learning models directly onto resource-constrained microcontrollers. Master sensor data collection, model optimization, quantization, and deployment using TensorFlow Lite for Microcontrollers.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12">
                                <div class="testimonial-one__single product-carousel-single">
                                    ...
                                    <p class="testimonial-one__text" style={{ "fontSize": "15px", "lineHeight": "1.8", "color": "#a0aec0" }}>Receive your verified TinyML & Edge AI specialist credential upon completing this advanced lab. Highlight your cloud interfacing, BLE telemetry, and low-latency smart IoT systems engineering competencies.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row align-items-stretch">
                    ...
                    <div class="col-lg-7 mb-5 mb-lg-0">
                        <div class="spotlight-content-wrapper">
                            ...
                            <h3 class="product-details__title" style={{ "fontSize": "36px", "fontWeight": "800", "color": "#1e293b", "lineHeight": "1.2", "marginBottom": "15px" }}>Master Edge AI and IoT Development</h3>
    ...
    <section class="course-highlights-section">
        <div class="container">
            ...
            {/* Row 1: What You Will Learn (left) + Key Applications (right) */}
            <div class="row" style={{ "display": "flex", "flexWrap": "wrap", "alignItems": "flex-start" }}>
                ...
                <div class="col-lg-6 mb-4 mb-lg-0" style={{ "alignSelf": "flex-start" }}>
                    <div class="ch-box wow fadeInLeft" data-wow-delay="100ms">
                        <div class="ch-box-title-wrapper">
                            ...
                            <h3 class="ch-box-title">What You Will Learn (Training Highlights)</h3>
                        </div>
                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-cloud"></i></div>
                            <div class="ch-feature-content">
                                <h5>Edge Computing vs. Cloud AI</h5>
                                <p>Introduction to Edge Computing concepts and how they compare with Cloud AI
                                    architectures.</p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            ...
                            <div class="ch-feature-content">
                                <h5>NodeMCU Hardware &amp; Firmware</h5>
                                <p>NodeMCU hardware, power optimization &amp; firmware flashing techniques.</p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            ...
                            <div class="ch-feature-content">
                                ...
                                <p>MQTT, CoAP, TLS security for secure IoT device communication.</p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-thermometer-half"></i></div>
                            <div class="ch-feature-content">
                                <h5>Sensor Integration</h5>
                                <p>DHT22, MPU6050, BME280, PIR real-time data filtering, signal conditioning &amp;
                                    feature extraction.</p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-brain"></i></div>
                            <div class="ch-feature-content">
                                <h5>TinyML Model Deployment</h5>
                                <p>TinyML model deployment using TensorFlow Lite on low-power, resource-constrained
                                    devices.</p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-robot"></i></div>
                            <div class="ch-feature-content">
                                <h5>Edge Applications</h5>
                                <p>Computer vision, predictive maintenance, smart automation capstone projects.</p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-cloud-upload-alt"></i></div>
                            <div class="ch-feature-content">
                                <h5>Edge-to-Cloud Integration</h5>
                                <p>AWS Greengrass, OTA firmware security &amp; energy harvesting techniques for complete
                                    pipeline.</p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            ...
                            <div class="ch-feature-content">
                                <h5>Secure Device Communication &amp; Cloud Integration</h5>
                                <p>AWS IoT, Azure IoT Hub integration with best security practices.</p>
                            </div>
                        </div>
                    </div>
                </div>

                {/* Right Column: Key Applications + Edge AI vs Cloud AI */}
                <div class="col-lg-6" style={{ "alignSelf": "flex-start" }}>
                    ...
                    <div class="ch-box wow fadeInRight" data-wow-delay="100ms" style={{ "marginBottom": "20px" }}>
                        <div class="ch-box-title-wrapper">
                            <div class="ch-box-icon"><i class="fas fa-th-large"></i></div>
                            <h3 class="ch-box-title">Key Applications Covered</h3>
                        </div>
                        <table class="freertos-compare-table" style={{ "marginTop": "0" }}>
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Predictive maintenance using vibration sensors</td>
                                </tr>
                                <tr>
                                    <td><strong>Smart Agriculture</strong></td>
                                    <td>AI-driven irrigation based on soil moisture</td>
                                </tr>
                                <tr>
                                    <td><strong>Smart Home</strong></td>
                                    <td>Voice-controlled devices with custom wake-word</td>
                                </tr>
                                <tr>
                                    <td><strong>Automotive</strong></td>
                                    <td>Edge-based anomaly detection for onboard diagnostics</td>
                                </tr>
                                <tr>
                                    <td><strong>Remote Monitoring</strong></td>
                                    <td>Real-time sensor streaming over MQTT</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>

                    {/* Edge AI vs Cloud AI Box */}
                    <div class="ch-box wow fadeInRight" data-wow-delay="200ms">
                        <div class="ch-box-title-wrapper">
                            <div class="ch-box-icon"><i class="fas fa-balance-scale"></i></div>
                            <h3 class="ch-box-title">Edge AI vs. Cloud AI A Comparison</h3>
                        </div>
                        <table class="freertos-compare-table" style={{ "marginTop": "0" }}>
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <tr>
                                    <td>Latency</td>
                                    <td class="highlight-cell">? Ultra-Low</td>
                                    <td>?? High</td>
                                </tr>
                                <tr>
                                    <td>Bandwidth</td>
                                ...
                                <tr>
                                    <td>Privacy</td>
                                    <td class="highlight-cell">?? High (local)</td>
                                    <td>? Low (data leaves)</td>
                                </tr>
                                <tr>
                                    <td>Power Consumption</td>
                                    <td class="highlight-cell">?? Optimized</td>
            ...
            <div class="row" style={{ "marginTop": "24px", "display": "flex", "flexWrap": "wrap", "alignItems": "flex-start" }}>
                ...
                <div class="col-lg-6 mb-4 mb-lg-0" style={{ "alignSelf": "flex-start" }}>
                    <div class="ch-box wow fadeInLeft" data-wow-delay="100ms">
                        <div class="ch-box-title-wrapper">
                            ...
                            <h3 class="ch-box-title">Why Choose Our Edge AI &amp; IoT Program?</h3>
                        </div>
                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-user-tie"></i></div>
                            <div class="ch-feature-content">
                                <h5>Delivered by Industry Professionals</h5>
                                <p>Learn directly from seasoned engineers and architects with years of real-world IoT
                                    and AI project experience.</p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-tools"></i></div>
                            <div class="ch-feature-content">
                                <h5>80% Hands-On, 20% Theory</h5>
                                <p>Master skills by building real projects not just listening to lectures.
                                    Experience-driven learning ensures you can apply your knowledge immediately.</p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-globe"></i></div>
                            <div class="ch-feature-content">
                                <h5>End-to-End Training: From Sensor Data to Cloud</h5>
                                <p>Understand the complete lifecycle: data acquisition, edge processing, AI inference,
                                    secure communication, and cloud integration.</p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-shield-alt"></i></div>
                            <div class="ch-feature-content">
                                <h5>Focus on IoT Security &amp; Deployment</h5>
                                <p>Learn best practices for securing IoT devices, encrypting data, managing firmware
                                    updates, and safely deploying AI models at the edge.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6" style={{ "alignSelf": "flex-start" }}>
                    <div class="ch-box wow fadeInRight" data-wow-delay="200ms">
                        <div class="ch-box-title-wrapper">
                            <div class="ch-box-icon"><i class="fas fa-toolbox"></i></div>
                            <h3 class="ch-box-title">Industry-Standard Tools &amp; Platforms</h3>
                        </div>
                        <p class="ch-box-desc">Work with modern tools used by top industry professionals:</p>
                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-code"></i></div>
                            <div class="ch-feature-content">
                                <h5>Arduino IDE</h5>
                                <p>For microcontroller programming on NodeMCU and embedded platforms.</p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            ...
                            <div class="ch-feature-content">
                                <h5>Node-RED</h5>
                                <p>For rapid IoT prototyping and visual flow-based programming.</p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-brain"></i></div>
                            <div class="ch-feature-content">
                                ...
                                <p>For on-device AI model deployment and inference on edge hardware.</p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            ...
                            <div class="ch-feature-content">
                                <h5>MQTT Protocol</h5>
                                <p>For lightweight, reliable IoT communication between devices and cloud.</p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fab fa-aws"></i></div>
                            <div class="ch-feature-content">
                                <h5>AWS IoT Core</h5>
                                <p>For seamless cloud integration and device management at scale.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="why-choose-one__left">
                        <div class="section-title text-left sec-title-animation animation-style2">
                            ...
                            <h2 class="section-title__title title-animation">VAct Technologies
                                ...
                                <span>Master Edge AI and IoT Development
                                </span>
                            </h2>
                        </div>
                        <p class="why-choose-one__text"> VAct Technologies Master Edge AI and IoT Development
                            provides
