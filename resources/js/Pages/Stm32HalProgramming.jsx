...
export default function Stm32HalProgramming() {
    return (
        <MainLayout>
            <Head title="Stm32HalProgramming" />
            
{/* BREADCRUMBS SECTION START */}
    <section class="ul-breadcrumb ul-section-spacing">
        <div class="ul-container">
            <h2 class="ul-breadcrumb-title">STM32 HAL Programming</h2>
            <ul class="ul-breadcrumb-nav">
                <li><a href="index.html">Home</a></li>
                <li><span class="separator"><i class="flaticon-right"></i></span></li>
                <li>STM32 HAL Programming</li>
            </ul>
        </div>
    </section>
                            ...
                            <div class="col-xl-5 col-lg-5 col-md-12">
                                <div class="product-carousel-img-container">
                                    <div class="testimonial-one__img">
                                        <img src="/assets/images/training/embedded.png" alt="STM32 HAL Programming" style={{ "width": "100%", "borderRadius": "8px" }} />
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-12">
                                <div class="testimonial-one__single product-carousel-single">
                                    ...
                                    <h2 class="product-carousel-title">
                                        STM32 HAL and <br /><span style={{ "color": "#008ed2" }}>CubeMX Framework</span></h2>
                                    <p class="testimonial-one__text" style={{ "fontSize": "15px", "lineHeight": "1.8", "color": "#a0aec0" }}>Accelerate product development using STM32CubeMX and the ST Hardware Abstraction Layer (HAL). Configure clocks, generate startup code, and build structured, portable embedded C applications quickly.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12">
                                <div class="testimonial-one__single product-carousel-single">
                                    ...
                                    <p class="testimonial-one__text" style={{ "fontSize": "15px", "lineHeight": "1.8", "color": "#a0aec0" }}>Receive your STM32 HAL & CubeMX Developer certificate. Prove your hands-on ability to program peripherals, use STM32CubeIDE debugger tools, and interface sensors using ST's Hardware Abstraction Layer.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row align-items-stretch">
                    ...
                    <div class="col-lg-7 mb-5 mb-lg-0">
                        <div class="spotlight-content-wrapper">
                            ...
                            <h3 class="product-details__title" style={{ "fontSize": "36px", "fontWeight": "800", "color": "#1e293b", "lineHeight": "1.2", "marginBottom": "15px" }}>STM32 Microcontroller Programming with HAL</h3>
                            <p style={{ "fontWeight": "700", "color": "var(--eduvers-base)", "fontSize": "18px", "marginBottom": "20px" }}>Master Rapid Prototyping and Robust System Design with STM32 HAL Library</p>
                            ...
                            <p class="testimonial-one__text" style={{ "fontSize": "15px", "lineHeight": "1.8", "color": "#64748b", "marginBottom": "25px" }}>
                                This program imparts practical expertise in STM32 programming with a focus on hands-on skills utilizing the HAL library. At VAct Technologies, we delve deep into the nuances of STM32 microcontrollers, their various types, advantages, and distinctive features to ensure you are industry-ready.
                            </p>
    ...
    <section>
        <div class="syllabus-wrapper">
            <h2 class="syllabus-title">STM32 Microcontroller Programming with HAL Syllabus</h2>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <span class="ms-3">Introduction to STM32 Microcontrollers</span>
                    ...
                    <div id="m1" class="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                        <div class="accordion-body">
                            <ul class="syllabus-points">
                                <li><span class="dot"></span> Overview of STM32 microcontroller families</li>
                                <li><span class="dot"></span> STM32 development tools and IDE setup (e.g., STM32CubeIDE)</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <span class="ms-3">Getting Started with STM32 HAL</span>
                            <span class="plus-icon">+</span>
                        </button>
                    </h2>
                    <div id="m2" class="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                        <div class="accordion-body">
                            <ul class="syllabus-points">
                                <li><span class="dot"></span> Introduction to HAL (Hardware Abstraction Layer)</li>
                                <li><span class="dot"></span> Configuring GPIO pins and using HAL functions</li>
                                <li><span class="dot"></span> Implementing simple input and output operations</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <span class="ms-3">Timers and Interrupts</span>
                            <span class="plus-icon">+</span>
                        </button>
                    </h2>
                    <div id="m3" class="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                        <div class="accordion-body">
                            <ul class="syllabus-points">
                                <li><span class="dot"></span> Introduction to timers and their applications</li>
                                <li><span class="dot"></span> Configuring and using timers with HAL</li>
                                <li><span class="dot"></span> Interrupt handling in STM32 with HAL</li>
                                <li><span class="dot"></span> Pulse Width Modulation</li>
                                <li><span class="dot"></span> Input Capture and Compare</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <span class="ms-3">Advanced GPIO Control</span>
                            <span class="plus-icon">+</span>
                        </button>
                    </h2>
                    <div id="m4" class="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                        <div class="accordion-body">
                            <ul class="syllabus-points">
                                <li><span class="dot"></span> Using HAL for more complex GPIO operations</li>
                                <li><span class="dot"></span> Implementing GPIO interrupts and EXTI lines</li>
                                <li><span class="dot"></span> Working with GPIO ports and pins effectively</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <span class="ms-3">UART Communication</span>
                            <span class="plus-icon">+</span>
                        </button>
                    </h2>
                    <div id="m5" class="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                        <div class="accordion-body">
                            <ul class="syllabus-points">
                                <li><span class="dot"></span> Understanding UART communication</li>
                                <li><span class="dot"></span> Configuring UART peripherals with HAL</li>
                                <li><span class="dot"></span> Implementing UART-based communication with other devices</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <span class="ms-3">SPI and I2C Communication</span>
                            <span class="plus-icon">+</span>
                        </button>
                    </h2>
                    <div id="m6" class="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                        <div class="accordion-body">
                            <ul class="syllabus-points">
                                <li><span class="dot"></span> Introduction to SPI and I2C communication protocols</li>
                                <li><span class="dot"></span> Configuring SPI and I2C peripherals with HAL</li>
                                <li><span class="dot"></span> Implementing SPI and I2C communication with sensors and peripherals</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <span class="ms-3">Analog-to-Digital Conversion (ADC)</span>
                            <span class="plus-icon">+</span>
                        </button>
                    </h2>
                    <div id="m7" class="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                        <div class="accordion-body">
                            <ul class="syllabus-points">
                                <li><span class="dot"></span> Overview of ADC and its applications</li>
                                <li><span class="dot"></span> Configuring and using the ADC with HAL</li>
                                <li><span class="dot"></span> Reading analog sensor data and converting it to digital values</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <span class="ms-3">PWM and Motor Control</span>
                            <span class="plus-icon">+</span>
                        </button>
                    </h2>
                    <div id="m8" class="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                        <div class="accordion-body">
                            <ul class="syllabus-points">
                                <li><span class="dot"></span> Understanding Pulse Width Modulation (PWM)</li>
                                <li><span class="dot"></span> Configuring PWM output with HAL</li>
                                <li><span class="dot"></span> Implementing motor control using PWM</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <span class="ms-3">Real-time Operating System</span>
                            <span class="plus-icon">+</span>
                        </button>
                    </h2>
                    <div id="m9" class="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                        <div class="accordion-body">
                            <ul class="syllabus-points">
                                <li><span class="dot"></span> Introduction to RTOS concepts</li>
                                <li><span class="dot"></span> Configuring FreeRTOS for STM32 with HAL</li>
                                <li><span class="dot"></span> Implementing multitasking applications</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <span class="ms-3">Basic CAN Communication</span>
                            <span class="plus-icon">+</span>
                        </button>
                    </h2>
                    <div id="m10" class="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                        <div class="accordion-body">
                            <ul class="syllabus-points">
                                <li><span class="dot"></span> Creating simple CAN communication applications</li>
                                <li><span class="dot"></span> Sending and receiving CAN messages using HAL</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="why-choose-one__left">
                        <div class="section-title text-left sec-title-animation animation-style2">
                            ...
                            <h2 class="section-title__title title-animation">VAct Technologies
                                ...
                                <span>STM32 Microcontroller ?
                                    Programming with HAL </span>
                            </h2>
                        </div>
                        <p class="why-choose-one__text"> VAct Technologies STM32 Microcontroller ?
                            Programming with HAL course
                            provides
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-4 mt-5 pt-4">
                                <div class="why-choose-one__single-img">
                                    ...
                                    <img src="/assets/images/resources/why.png.jpeg"
                                        alt="Why Choose VAct Technologies" class="img-fluid" />
                            ...
                            <div class="col-xl-4 col-lg-4">
                                <div class="why-choose-one__single">
                                    ...
                                    <p class="why-choose-one__single-text">Learn using industry-standard VAct Auto
                                        Edge
                            ...
                            <div class="testimonial-four__single-inner">
                                ...
                                <div class="testimonial-four__content-box">
                                    ...
                                    <p class="testimonial-four__text">Dinesh Babu from Batch 51 secured a role as an
                                        ...
                                        skills and dedication helped him gain 2 years of successful industry
                                        experience.
                                    </p>
                        ...
                        <div class="testimonial-four__single">
                            ...
                            <div class="testimonial-four__single-inner">
                                ...
                                <div class="testimonial-four__content-box">
                                    ...
                                    <p class="testimonial-four__text">Abinaya secured a role as Senior Software
                                        Engineer
                                        Automotive. With 4.5 years
                                        of
                        ...
                        <div class="testimonial-four__single">
                            ...
                            <div class="testimonial-four__single-inner">
                                ...
                                <div class="testimonial-four__content-box">
                                    ...
                                    <p class="testimonial-four__text">Mukesh.E secured a Mechanical Design P3 role
                                        with
                                        an impressive salary package of 7 LPA. His 7 years of experience showcase
                                        his
                        ...
                        <div class="testimonial-four__single">
                            ...
                            <div class="testimonial-four__single-inner">
                                ...
                                <div class="testimonial-four__content-box">
                                    ...
                                    <p class="testimonial-four__text">KARTHICK T achieved placement as a Hardware
                                        Design
                                        Engineer. With 6.5 years of
                                        experience, he has gained strong expertise in hardware design and
                                        validation.
                                    </p>
