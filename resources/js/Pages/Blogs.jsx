            ...
            <section className="blog-one">
                <div className="container">
                    <div className="section-title text-center sec-title-animation animation-style1">
                        ...
                        <h2 className="section-title__title title-animation">Insights &amp; updates for<br /> modern
                            <span>learners</span>
                        </h2>
                    </div>
                    <div className="row">
                        {blogs.map((b, i) => (
                            <div key={b.id} className={`col-xl-4 col-lg-6 ${animations[i % 3]}`} data-wow-delay={delays[i % 3]}>
                                <div className="blog-one__single">
                                    <div className="blog-one__img">
                                        <img src={imgUrl(b.image)} alt={b.title} />
                                        <div className="blog-one__plus">
                                            <a href="/blogdetails"><i className="icon-plus"></i></a>
                                        </div>
                                    ...
                                    <div className="blog-one__content">
                                        <ul className="blog-one__meta list-unstyled">
                                            <li>
                                                <a href="#">
                                                    <span className="fas fa-calendar-alt"></span>{b.card_date || 'May 10, 2025'}
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                                        ...
                                        <h3 className="blog-one__title"><a href="/blogdetails">{b.title}</a></h3>
                            ...
                            <div className="item">
                                <div className="testimonial-two__single">
                                    <div className="testimonial-two__single-inner">
                                        ...
                                        <p className="testimonial-two__text">The embedded systems training at VAct Technologies was very informative and practical. The real-time projects improved my technical skills and confidence.</p>
                            ...
                            <div className="item">
                                <div className="testimonial-two__single">
                                    <div className="testimonial-two__single-inner">
                                        ...
                                        <p className="testimonial-two__text">VAct Technologies provided excellent guidance throughout my internship. The trainers explained every concept clearly with hands-on experience.</p>
                                        <div className="testimonial-two__client-info">
                                            <div className="testimonial-two__client-img">
                            ...
                            <div className="item">
                                <div className="testimonial-two__single">
                                    <div className="testimonial-two__single-inner">
                                        ...
                                        <p className="testimonial-two__text">The internship program helped me understand embedded systems and IoT applications in a practical way. The mentors were very supportive.</p>
                                        <div className="testimonial-two__client-info">
                                            <div className="testimonial-two__client-img">
                            ...
                            <div className="item">
                                <div className="testimonial-two__single">
                                    <div className="testimonial-two__single-inner">
                                        ...
                                        <p className="testimonial-two__text">I gained valuable knowledge in firmware development and embedded technology during my internship. The training sessions were interactive and useful.</p>
                                        <div className="testimonial-two__client-info">
                                            <div className="testimonial-two__client-img">
