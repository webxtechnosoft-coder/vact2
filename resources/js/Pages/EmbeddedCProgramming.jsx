...
export default function EmbeddedCProgramming() {
    return (
        <MainLayout>
            <Head title="EmbeddedCProgramming" />
            <link rel="stylesheet" href="/assets/css/embedded-c-programming.css" />
            
{/* BREADCRUMBS SECTION START */}
    <section class="ul-breadcrumb ul-section-spacing">
        <div class="ul-container">
            <h2 class="ul-breadcrumb-title">Embedded C Programming</h2>
                            ...
                            <div class="col-xl-5 col-lg-5 col-md-12">
                                <div class="product-carousel-img-container">
                                    <div class="testimonial-one__img">
                                        <img src="/assets/images/training/embedded_c.png" alt="Embedded C Programming" style={{ "width": "100%", "borderRadius": "8px" }} />
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-12">
                                <div class="testimonial-one__single product-carousel-single">
                                    ...
                                    <h2 class="product-carousel-title">
                                        Embedded C <br /><span style={{ "color": "#008ed2" }}>Programming Mastery</span></h2>
                                    <p class="testimonial-one__text" style={{ "fontSize": "15px", "lineHeight": "1.8", "color": "#a0aec0" }}>Master the core of microcontroller firmware development. Learn memory mapping, pointer manipulations, bitwise math, structures, and register-level programming techniques designed to build high-efficiency bare-metal code.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12">
                                <div class="testimonial-one__single product-carousel-single">
                                    ...
                                    <p class="testimonial-one__text" style={{ "fontSize": "15px", "lineHeight": "1.8", "color": "#a0aec0" }}>Validate your low-level programming skills. This professional certificate verifies your register-level coding, custom driver development, and hardware lab interfacing competencies using elite automotive boards.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row align-items-stretch">
                    ...
                    <div class="col-lg-7 mb-5 mb-lg-0">
                        <div class="spotlight-content-wrapper">
                            ...
                            <h3 class="product-details__title" style={{ "fontSize": "36px", "fontWeight": "800", "color": "#1e293b", "lineHeight": "1.2", "marginBottom": "15px" }}>Embedded C Programming Course</h3>
                            <p style={{ "fontWeight": "700", "color": "var(--eduvers-base)", "fontSize": "18px", "marginBottom": "20px" }}>Build Embedded Systems with Precision and Performance:</p>
                            <p class="product-details__content-text1" style={{ "background": "rgba(0, 142, 210, 0.02)", "borderLeft": "4px solid var(--eduvers-base)", "padding": "15px 20px", "borderRadius": "4px 12px 12px 4px", "fontSize": "15px", "fontWeight": "600", "color": "#475569", "lineHeight": "1.6", "marginBottom": "20px" }}>
                                Our comprehensive embedded C programming course is your gateway to mastering the art of programming these remarkable devices using the C programming language. Explore the core of microcontroller programming and practical simulation experience to boost your career prospects.
                            </p>
                            <p class="testimonial-one__text" style={{ "fontSize": "15px", "lineHeight": "1.8", "color": "#64748b", "marginBottom": "20px" }}>
                                <strong>Embedded Systems Mastery with AutoEdge:</strong><br />
                                Delve into Automotive protocols and embedded systems effortlessly, as our embedded c courses uniquely utilizes the only board in India for such specialized training - <strong>AutoEdge Development Board</strong>.
                            </p>
                            <p class="testimonial-one__text" style={{ "fontSize": "15px", "lineHeight": "1.8", "color": "#64748b", "marginBottom": "25px" }}>
                                Leverage the advanced features of the AutoEdge Development Board, boasting 1 MB Flash program memory, 192+4 Kbytes Data SRAM, and peripherals like a 16x2 LCD, Potentiometers, and OLED display. Enhance your skills with industry-standard learning through the HAL Driver Interface.
                            </p>
                    ...
                    <div class="col-lg-5">
                        <div class="spotlight-image-container" style={{ "minHeight": "480px", "overflow": "visible !important", "padding": "20px 10px 20px 50px !important" }}>
                            <div class="spotlight-image-glow"></div>
                            <div class="board-wrapper" style={{ "marginLeft": "-20px", "maxWidth": "100%", "position": "relative" }}>
                                <img src="/assets/images/training/all.png" class="board-image-el spotlight-img img-fluid" alt="Embedded Automotive Training Overview" style={{ "borderRadius": "12px", "width": "100%", "height": "auto", "objectFit": "contain" }} />
                ...
                <div class="col-lg-6 mb-4 mb-lg-0" style={{ "alignSelf": "flex-start" }}>
                    <div class="ch-box wow fadeInLeft" data-wow-delay="100ms">
                        <div class="ch-box-title-wrapper">
                            ...
                            <h3 class="ch-box-title">Course Content</h3>
                        </div>
                        <p class="ch-box-desc">Master the core principles of embedded system programming through our structured, topic-wise modules.</p>
                        <div class="ch-feature-item">
                            <span style={{ "display": "inline-flex", "alignItems": "center", "justifyContent": "center", "width": "28px", "height": "28px", "background": "#008ed2", "color": "#fff", "borderRadius": "50%", "fontSize": "12px", "fontWeight": "bold", "marginRight": "15px", "flexShrink": "0" }}>01</span>
                            <div class="ch-feature-content">
                                <p style={{ "fontSize": "14.5px", "margin": "0", "color": "#4D5756" }}><strong>C Introduction</strong> ? C Code execution flow, Variables, Data types &amp; Operators.</p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            <span style={{ "display": "inline-flex", "alignItems": "center", "justifyContent": "center", "width": "28px", "height": "28px", "background": "#008ed2", "color": "#fff", "borderRadius": "50%", "fontSize": "12px", "fontWeight": "bold", "marginRight": "15px", "flexShrink": "0" }}>02</span>
                            <div class="ch-feature-content">
                                <p style={{ "fontSize": "14.5px", "margin": "0", "color": "#4D5756" }}><strong>Decision Making</strong> ? if, if-else, nested if, if-else-if, switch case (Refer AS Annexure)</p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            <span style={{ "display": "inline-flex", "alignItems": "center", "justifyContent": "center", "width": "28px", "height": "28px", "background": "#008ed2", "color": "#fff", "borderRadius": "50%", "fontSize": "12px", "fontWeight": "bold", "marginRight": "15px", "flexShrink": "0" }}>03</span>
                            <div class="ch-feature-content">
                                <p style={{ "fontSize": "14.5px", "margin": "0", "color": "#4D5756" }}><strong>Looping</strong> ? for, while, do-while (Refer AS Annexure)</p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            <span style={{ "display": "inline-flex", "alignItems": "center", "justifyContent": "center", "width": "28px", "height": "28px", "background": "#008ed2", "color": "#fff", "borderRadius": "50%", "fontSize": "12px", "fontWeight": "bold", "marginRight": "15px", "flexShrink": "0" }}>04</span>
                            <div class="ch-feature-content">
                                <p style={{ "fontSize": "14.5px", "margin": "0", "color": "#4D5756" }}><strong>Arrays</strong> ? 1D, 2D (Refer AS Annexure)</p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            <span style={{ "display": "inline-flex", "alignItems": "center", "justifyContent": "center", "width": "28px", "height": "28px", "background": "#008ed2", "color": "#fff", "borderRadius": "50%", "fontSize": "12px", "fontWeight": "bold", "marginRight": "15px", "flexShrink": "0" }}>05</span>
                            <div class="ch-feature-content">
                                <p style={{ "fontSize": "14.5px", "margin": "0", "color": "#4D5756" }}><strong>Strings</strong> (Refer AS Annexure)</p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            <span style={{ "display": "inline-flex", "alignItems": "center", "justifyContent": "center", "width": "28px", "height": "28px", "background": "#008ed2", "color": "#fff", "borderRadius": "50%", "fontSize": "12px", "fontWeight": "bold", "marginRight": "15px", "flexShrink": "0" }}>06</span>
                            <div class="ch-feature-content">
                                <p style={{ "fontSize": "14.5px", "margin": "0", "color": "#4D5756" }}><strong>Functions in C</strong></p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            <span style={{ "display": "inline-flex", "alignItems": "center", "justifyContent": "center", "width": "28px", "height": "28px", "background": "#008ed2", "color": "#fff", "borderRadius": "50%", "fontSize": "12px", "fontWeight": "bold", "marginRight": "15px", "flexShrink": "0" }}>07</span>
                            <div class="ch-feature-content">
                                <p style={{ "fontSize": "14.5px", "margin": "0", "color": "#4D5756" }}><strong>Bitwise Operators</strong></p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            <span style={{ "display": "inline-flex", "alignItems": "center", "justifyContent": "center", "width": "28px", "height": "28px", "background": "#008ed2", "color": "#fff", "borderRadius": "50%", "fontSize": "12px", "fontWeight": "bold", "marginRight": "15px", "flexShrink": "0" }}>08</span>
                            <div class="ch-feature-content">
                                <p style={{ "fontSize": "14.5px", "margin": "0", "color": "#4D5756" }}><strong>Pointers</strong> (Refer AS Annexure)</p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            <span style={{ "display": "inline-flex", "alignItems": "center", "justifyContent": "center", "width": "28px", "height": "28px", "background": "#008ed2", "color": "#fff", "borderRadius": "50%", "fontSize": "12px", "fontWeight": "bold", "marginRight": "15px", "flexShrink": "0" }}>09</span>
                            <div class="ch-feature-content">
                                <p style={{ "fontSize": "14.5px", "margin": "0", "color": "#4D5756" }}><strong>Structures, Union, Linked List</strong> (Refer AS Annexure)</p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            <span style={{ "display": "inline-flex", "alignItems": "center", "justifyContent": "center", "width": "28px", "height": "28px", "background": "#008ed2", "color": "#fff", "borderRadius": "50%", "fontSize": "12px", "fontWeight": "bold", "marginRight": "15px", "flexShrink": "0" }}>10</span>
                            <div class="ch-feature-content">
                                <p style={{ "fontSize": "14.5px", "margin": "0", "color": "#4D5756" }}><strong>Enumeration, Typedef &amp; Macros</strong> ? Preprocessors (Refer AS Annexure)</p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            <span style={{ "display": "inline-flex", "alignItems": "center", "justifyContent": "center", "width": "28px", "height": "28px", "background": "#008ed2", "color": "#fff", "borderRadius": "50%", "fontSize": "12px", "fontWeight": "bold", "marginRight": "15px", "flexShrink": "0" }}>11</span>
                            <div class="ch-feature-content">
                                <p style={{ "fontSize": "14.5px", "margin": "0", "color": "#4D5756" }}><strong>Typedef &amp; Macros</strong> ? Preprocessors (Refer AS Annexure)</p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            <span style={{ "display": "inline-flex", "alignItems": "center", "justifyContent": "center", "width": "28px", "height": "28px", "background": "#008ed2", "color": "#fff", "borderRadius": "50%", "fontSize": "12px", "fontWeight": "bold", "marginRight": "15px", "flexShrink": "0" }}>12</span>
                            <div class="ch-feature-content">
                                <p style={{ "fontSize": "14.5px", "margin": "0", "color": "#4D5756" }}><strong>Revision</strong> (Refer AS Annexure)</p>
                            </div>
                        </div>
                        <div class="ch-feature-item">
                            <span style={{ "display": "inline-flex", "alignItems": "center", "justifyContent": "center", "width": "28px", "height": "28px", "background": "#008ed2", "color": "#fff", "borderRadius": "50%", "fontSize": "12px", "fontWeight": "bold", "marginRight": "15px", "flexShrink": "0" }}>13</span>
                            <div class="ch-feature-content">
                                <p style={{ "fontSize": "14.5px", "margin": "0", "color": "#4D5756" }}><strong>C Language Assessment</strong> (Refer AS Annexure)</p>
                            </div>
                        </div>
                    </div>
                </div>
                {/* Right Column: AutoEdge Board details + Why Choose */}
                <div class="col-lg-6" style={{ "alignSelf": "flex-start" }}>
                    {/* AutoEdge Development Board Box */}
                    <div class="ch-box wow fadeInRight" data-wow-delay="100ms" style={{ "marginBottom": "24px" }}>
                        <div class="ch-box-title-wrapper">
                            <div class="ch-box-icon"><i class="fas fa-microchip"></i></div>
                            <h3 class="ch-box-title">AutoEdge Development Board</h3>
                        </div>
                        <p class="ch-box-desc" style={{ "marginBottom": "15px" }}>Delve into Automotive protocols and embedded systems effortlessly, as our course uniquely utilizes the only board in India for such specialized training - <strong>AutoEdge Development Board</strong>.</p>
                        <p class="ch-box-desc" style={{ "marginBottom": "0" }}>Leverage the advanced features of the AutoEdge Development Board, boasting 1 MB Flash program memory, 192+4 Kbytes Data SRAM, and peripherals like a 16?2 LCD, Potentiometers, and OLED display. Enhance your skills with industry-standard learning through the HAL Driver Interface.</p>
                    </div>
                    {/* Why Choose Box */}
                    <div class="ch-box wow fadeInRight" data-wow-delay="200ms">
                        <div class="ch-box-title-wrapper">
                            <div class="ch-box-icon"><i class="fas fa-star"></i></div>
                            <h3 class="ch-box-title">Why Choose VAct Technologies?</h3>
                        </div>
                        <p class="ch-box-desc">Why Choose VAct Technologies embedded C programming course?</p>
                        {/* Benefit 1 */}
                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-graduation-cap"></i></div>
                            <div class="ch-feature-content">
                                <h5>Educational Enrichment</h5>
                                <p>Our program fosters deep understanding of embedded system software and development intricacies.</p>
                            </div>
                        </div>
                        {/* Benefit 2 */}
                        <div class="ch-feature-item">
                            ...
                            <div class="ch-feature-content">
                                ...
                                <p>Access cutting-edge training with our industry-standard VAct Auto Edge Development Board.</p>
                            </div>
                        </div>
                        {/* Benefit 3 */}
                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-trophy"></i></div>
                            <div class="ch-feature-content">
                                <h5>Pursuit of Excellence</h5>
                                <p>VAct Technologies ? Your gateway to top-tier embedded systems training in Chennai.</p>
                            </div>
                        </div>
                        {/* Benefit 4 */}
                        <div class="ch-feature-item">
                            ...
                            <div class="ch-feature-content">
                                <h5>Industry-Driven</h5>
                                <p>Designed in collaboration with automotive leaders, meeting industry demands.</p>
                            </div>
                        </div>
                        {/* Benefit 5 */}
                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-chalkboard-teacher"></i></div>
                            <div class="ch-feature-content">
                                <h5>Guided by Experts</h5>
                                <p>Begin your embedded software journey with our seasoned expert team.</p>
                            </div>
                        </div>
                        {/* Benefit 6 */}
                        <div class="ch-feature-item">
                            <div class="ch-feature-icon"><i class="fas fa-heart"></i></div>
                            <div class="ch-feature-content">
                                <h5>Your Achievement, Our Devotion</h5>
                                <p>VAct Technologies is dedicated to your accomplishments.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="why-choose-one__left">
                        <div class="section-title text-left sec-title-animation animation-style2">
                            ...
                            <h2 class="section-title__title title-animation">VAct Technologies
                                <span>Embedded C Programming Course</span>
                            </h2>
                        </div>
                        <p class="why-choose-one__text"> VAct Technologies Embedded C Programming Course provides
